...
I am searching for a summer internship or part-time job as a junior data analyst or scientist. I am dying to apply what I learn to real life!

- __What skills are you learning in your current MS program?__
A ton of statistical methods and how to use them in R, Python, Pandas, SQL. I have learned and continuously practiced estimation and hypothesis testing; learning desirable properties of estimators; maximum likelihood; 
one- and two-sample problems; modeling categorical and count data—contingency tables; proportions, risk and odds; logistic regression; log-linear regression mixed effects models; data imputation; prediction and cross-validation; multivariate analytics with the basics of matrix algebra; principal components analysis; cluster analysis; factor analysis; and multidimensional scaling.
